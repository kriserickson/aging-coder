...
Once, because I was in the middle of something and curious what it cost when you pay by the token, I added $5 of extra usage to see how far it would take me. It barely completed the task it was performing when it had run out of tokens on in the first place (it edited six files, with 71 insertions and 59 deletions) and chewed through $4.11 in about 5 minutes 27 seconds (and it still didn't fix the issue I was having, I had to switch to Codex for the final fix, though that took 3 prompts).
